...
## Magazine capacity
Most weapons have one bullet loaded in the chamber. For those this value is dislpayed as <magazine capacity>+1 (e.g. 30+1, 20+1, etc.). For all other weapons it is displayed as <magazine capacity>+0 (e.g. 100+0, 80+0). soon (tm)
