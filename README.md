...
## Damage per shot
The damage per shot calculates as $DmgPerShot = Damage * Pellet count$. Only for shotguns this value varies from the damage per bullet. No measuring necessary.
## Fire rate
